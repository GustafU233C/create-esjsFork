...
export function nodeVersionWarning() {
  try {
    ...
    if (major < 10) {
      console.log(
        yellow(
          `Tu versión actual de Node es ${process.version}, sin embargo la recomendación es un mínimo de Node v10. Ten en cuenta que las futuras versiones de EsJS eventualmente eliminarán el soporte para versiones de Node no LTS.`,
        ),
      );
    }
  } catch (e) {}
